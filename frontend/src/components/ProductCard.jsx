      ...
      <article className="product-card">
        ...
        <div className="product-card__media">
          ...
          <div className="product-card__image-wrapper">
            ...
            <Link href={`/shop-details?${resolvedProduct.name ? resolvedProduct.name.toString().trim().replace(/\s+/g, '-').replace(/[^\w\-]+/g, '').replace(/\-\-+/g, '-') : resolvedProduct._id}`} style={{ display: 'block', position: 'relative', height: '100%', width: '100%' }}>
              <Swiper
        ...
        <div className="product-card__content">
          ...
          <Link href={`/shop-details?${resolvedProduct.name ? resolvedProduct.name.toString().trim().replace(/\s+/g, '-').replace(/[^\w\-]+/g, '').replace(/\-\-+/g, '-') : resolvedProduct._id}`} style={{ textDecoration: 'none', marginBottom: 'auto' }}>
          ...
          <div className="product-card__actions" style={{ display: 'flex', gap: '8px', marginTop: 'auto' }}>
            {resolvedProduct.stock <= 0 ? (
              <Link
                href={`/shop-details?${resolvedProduct.name ? resolvedProduct.name.toString().trim().replace(/\s+/g, '-').replace(/[^\w\-]+/g, '').replace(/\-\-+/g, '-') : resolvedProduct._id}`}
