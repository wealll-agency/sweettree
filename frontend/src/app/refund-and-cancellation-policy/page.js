...
export const metadata = {
  title: 'Refund Policy | Sweettree',
  description: 'Refund Policy, Privacy, and Terms for using the Sweettree website.',
};
        ...
        <div className="col-lg-10">
          <div className="card shadow-sm border-0 rounded-4 p-4 p-md-5 bg-white">
            ...
            <section className="mb-5">
              ...
              <h3 className="h5 fw-bold mt-4 mb-3" style={{ color: '#333' }}>Mandatory Refund Requirements</h3>
              <ul style={{ color: '#555', lineHeight: '1.8' }}>
                <li className="mb-2"><strong>Unboxing Video:</strong> If you want to request a refund, you must record a proper, continuous unboxing video of the package at the time of delivery/opening.</li>
                <li className="mb-2"><strong>Verification:</strong> A refund will only be considered if there is a valid issue or a defective product. You must send the proper unboxing video to us. The owner will verify the evidence, and the refund will be issued strictly based on that verification.</li>
              </ul>
