...
export default function AdminComboEditPage() {
  ...
  const addComponent = (product) => {
    ...
    if (exists) {
      showAlert('This product size is already in the combo.', 'warning');
      return;
    }
    const newComponent = {
      product: product._id,
  ...
  if (loading) {
    return <div className="text-center py-5">Loading combo data...</div>;
  }
      ...
      <div className="d-flex justify-content-between align-items-center mb-4 pb-3 border-bottom border-secondary border-opacity-25">
        <div className="d-flex align-items-center gap-3">
          ...
          <div>
            ...
            <p className="text-muted m-0">Update bundled product offering.</p>
          </div>
        </div>
