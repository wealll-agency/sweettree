...
export default function OrderHistoryPage() {
  ...
  return (
    <div className="container py-5 animate-fade-in">
      <h1 className="fw-bold mb-4 display-font">My Orders</h1>

      {orders.length === 0 ? (
        <div className="text-center py-5 glass-card bg-white max-w-lg mx-auto">
          <ShoppingBag size={48} className="text-muted mb-2 mx-auto" />
          ...
          <Link href="/products" className="btn btn-brand">Browse Products</Link>
        </div>
      ) : (
